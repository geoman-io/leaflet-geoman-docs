...
You can also define custom snap guide angles. The default snap guide angles value is `[90]` which will be repeated and results into `[0, 90, 180, 270]`. You can define your custom angles by setting `snapGuidesAngles` in the `global` options.
