...
![Difference Feature](https://assets.geoman.io//assets/difference.gif)
...
| difference(`layer1`, `layer2`) | -         | Subtracts the second selected layer from the first selected layer.          |
